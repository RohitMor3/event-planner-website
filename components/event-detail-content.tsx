    ...
    return <div className="flex flex-col gap-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        ...
                        {inviteUrl ? (<div className="rounded-md border border-[var(--border)] bg-[var(--surface)] p-3 text-sm">
                            {inviteUrl}
                        </div>): (<p className="text-sm text-[var(--muted-foreground)]">No Invite Link generated yet</p>)}
                ...
                <Card>
                    ...
                    <CardContent>
                        {rsvps.length === 0 ? (<p className="text-sm text-[var(--muted-foreground)]">No Responses yet.</p>
                    ):(<Table>
                        <TableHeader>
                            <TableRow>
